...
export const NEW_MONSTER: IMonster = {
    ...
    stats: {
        ...
        charisma: 10,
        proficiencies: [
            { value: 0, proficiency: { index: "saving-throw-str", name: "Saving Throw: STR", url: "" } },
            { value: 0, proficiency: { index: "saving-throw-dex", name: "Saving Throw: DEX", url: "" } },
            { value: 0, proficiency: { index: "saving-throw-con", name: "Saving Throw: CON", url: "" } },
            { value: 0, proficiency: { index: "saving-throw-wis", name: "Saving Throw: WIS", url: "" } },
            { value: 0, proficiency: { index: "saving-throw-int", name: "Saving Throw: INT", url: "" } },
