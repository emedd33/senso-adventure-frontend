...
const ProfileIndex: React.FC<ProfileIndexProps> = () => {
    ...
    const email = useSelector((state: RootReducerProp) => state.admin.authUser?.email)
            ...
            <Route exact path="/profile">
                <ContentContainer >
                    ...
                    <div style={{ flex: 8, width: "90%" }}>
                        ...
                        <Button variant="contained" color="primary" onClick={() => setIsChangingPassword(!isChangingPassword)}>
                            {isChangingPassword ?
                                "Close window" :
                                "Change password"
                            }
                                ...
                                >
                                    ...
                                    <div style={{ display: "flex", justifyContent: "center", alignItems: "center", flex: 1 }}>
                                        ...
                                        <TextField
                                            ...
                                            margin="normal"
                                            style={{ width: "90%" }}
                                            onChange={(event) => setFirstNewPassword(event.target.value)}
                                        />
                                    </div>
                                    <div style={{ display: "flex", justifyContent: "center", alignItems: "center", flex: 1 }}>
                                        ...
                                        <TextField
                                            ...
                                            margin="normal"
                                            style={{ width: "90%" }}
                                            onChange={(event) => setSecondNewPassword(event.target.value)}
                                        />
                                    </div>
