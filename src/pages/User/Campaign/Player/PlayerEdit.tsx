        ...
        <Container>
            <div style={{ gridColumn: "1/3" }}>
                <h1 style={{ marginBottom: "0" }}>
                    {selectedPlayer.player.name} {selectedPlayer.player.isPublished === "FALSE" ? `(${translate.t('Not published')})` : null}
                </h1>
            </div>
            ...
            <h2 style={{ gridColumn: "1/3", textAlign: "center" }}>{translate.t('Basic info')}</h2>
            <SensoTextInput
            ...
            <h2 style={{ gridColumn: "1/3", textAlign: "center" }}>{translate.t('Player stats')}</h2>
            <SensoNumberInput
                ...
                <table style={{ border: "double", margin: "1rem" }}>
                    ...
                    <tbody>
                        ...
                        <SensoSkillInput
                            ...
                            abilityModifier={selectedPlayer.player.stats.dexterity}
                            label={`${translate.t('Animal Handling')} (${translate.t("Dex")})`}
                            proficiencyBonus={selectedPlayer.player.stats.proficiency}
                        />
                        <SensoSkillInput
                ...
                <table style={{ border: "double", margin: "1rem" }}>
                    ...
                    <tbody>
                        ...
                        <SensoSkillInput
                            ...
                            abilityModifier={selectedPlayer.player.stats.dexterity}
                            label={`${translate.t('Sleight of hand')} (${translate.t("Dez")})`}
                            proficiencyBonus={selectedPlayer.player.stats.proficiency}
                        />
                        <SensoSkillInput
