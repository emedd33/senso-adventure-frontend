    ...
    return (
        <Container>
            <div style={{ width: "90%" }}>
                ...
                >
                    ...
                    {isDungeonMaster ? (
                        <div style={{ gridColumn: "1/3" }}>
                            {translate.t("Level")}:{" "}
                            {`${parseValuesToString(selectedPlayer.player.level)}`}
                        </div>
                    ) : null}
                </div>
            </div>
            ...
            <>
              ...
              {getAbilityModifier(selectedPlayer.player.stats.strength.value)})
            </h3>
                        <div
                            style={{
                                paddingLeft: "0.2rem",
                        ...
                        >
                            {selectedPlayer.player.stats.strength.isProficient === "TRUE" ? (
              ...
              {getAbilityModifier(selectedPlayer.player.stats.dexterity.value)})
            </h3>
                        <div
                            style={{
                                paddingLeft: "0.2rem",
                        ...
                        >
                            {selectedPlayer.player.stats.dexterity.isProficient === "TRUE" ? (
                                <CheckIcon style={{ width: "0.8rem", color: "green" }} />
                            ) : null}
                            {translate.t("Saving")}:
              {getAbilityModifier(
              ...
              {getAbilityModifier(selectedPlayer.player.stats.wisdom.value)})
            </h3>
                        <div
                            style={{
                                paddingLeft: "0.2rem",
                        ...
                        >
                            {selectedPlayer.player.stats.wisdom.isProficient === "TRUE" ? (
                                <CheckIcon style={{ width: "0.8rem", color: "green" }} />
                            ) : null}
                            {translate.t("Saving")}:
              {getAbilityModifier(
              ...
              {getAbilityModifier(selectedPlayer.player.stats.charisma.value)})
            </h3>
                        <div
                            style={{
                                paddingLeft: "0.2rem",
                        ...
                        >
                            {selectedPlayer.player.stats.charisma.isProficient === "TRUE" ? (
                                <CheckIcon style={{ width: "0.8rem", color: "green" }} />
                            ) : null}
                            {translate.t("Saving")}:
              {getAbilityModifier(
                            ...
                            <Table>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <TableElement>
                                            {translate.t("Acrobatics")} ({translate.t("Dex")})
                    </TableElement>
                                    </tr>
                                    <tr>
                                        <TableElement>
                                        ...
                                        <TableElement>
                                            {translate.t("Animal handling")} ({translate.t("Dex")})
                    </TableElement>
                                    </tr>
                                    <tr>
                                        <TableElement>
                                            {parseStringBooleanToCheckmark(
                                                selectedPlayer.player.stats.skills.arcana.proficient,
                                                false
                                            )}
                                        </TableElement>
                                        <TableElement>
                                        ...
                                        <TableElement>
                                            {translate.t("Arcana")} ({translate.t("Int")})
                    </TableElement>
                                    </tr>
                                    <tr>
                                        <TableElement>
                                            {parseStringBooleanToCheckmark(
                                                selectedPlayer.player.stats.skills.athletics.proficient,
                                                false
                                            )}
                                        </TableElement>
                                        <TableElement>
                                        ...
                                        <TableElement>
                                            {translate.t("Athletics")} ({translate.t("Str")})
                    </TableElement>
                                    </tr>
                                    <tr>
                                        <TableElement>
                                            {parseStringBooleanToCheckmark(
                                                selectedPlayer.player.stats.skills.deception.proficient,
                                                false
                                            )}
                                        </TableElement>
                                        <TableElement>
                                        ...
                                        <TableElement>
                                            {translate.t("Deception")} ({translate.t("Cha")})
                    </TableElement>
                                    </tr>
                                    <tr>
                                        <TableElement>
                                            {parseStringBooleanToCheckmark(
                                                selectedPlayer.player.stats.skills.history.proficient,
                                                false
                                            )}
                                        </TableElement>
                                        <TableElement>
                                        ...
                                        <TableElement>
                                            {translate.t("History")} ({translate.t("Int")})
                    </TableElement>
                                    </tr>
                                </tbody>
                            </Table>
                            ...
                            <Table>
                                ...
                                <tbody>
                                    <tr>
                                        <TableElement>
                                            {parseStringBooleanToCheckmark(
                                                selectedPlayer.player.stats.skills.insight.proficient,
                                                false
                                            )}
                                        </TableElement>
                                        <TableElement>
                                        ...
                                        <TableElement>
                                            {translate.t("Insight")} ({translate.t("Wis")})
                    </TableElement>
                                    </tr>
                                    <tr>
                                        <TableElement>
                                        ...
                                        <TableElement>
                                            {translate.t("Intimidation")} ({translate.t("Cha")})
                    </TableElement>
                                    </tr>
                                    <tr>
                                        <TableElement>
                                    ...
                                    <tr>
                                        <TableElement>
                                            {parseStringBooleanToCheckmark(
                                                selectedPlayer.player.stats.skills.medicine.proficient,
                                                false
                                            )}
                                        </TableElement>
                                        <TableElement>
                                        ...
                                        <TableElement>
                                            {translate.t("Medicine")} ({translate.t("Wis")})
                    </TableElement>
                                    </tr>
                                    <tr>
                                        <TableElement>
                                            {parseStringBooleanToCheckmark(
                                                selectedPlayer.player.stats.skills.nature.proficient,
                                                false
                                            )}
                                        </TableElement>
                                        <TableElement>
                                        ...
                                        <TableElement>
                                            {translate.t("Nature")} ({translate.t("Int")})
                    </TableElement>
                                    </tr>
                                    <tr>
                                        <TableElement>
                                        ...
                                        <TableElement>
                                            {translate.t("Perception")} ({translate.t("Wis")})
                    </TableElement>
                                    </tr>
                                </tbody>
                            </Table>
                            ...
                            <Table>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <TableElement>
                                            {translate.t("Performance")} ({translate.t("Cha")})
                    </TableElement>
                                    </tr>
                                    <tr>
                                        <TableElement>
                                        ...
                                        <TableElement>
                                            {translate.t("Persuasion")} ({translate.t("Cha")})
                    </TableElement>
                                    </tr>
                                    <tr>
                                        <TableElement>
                                            {parseStringBooleanToCheckmark(
                                                selectedPlayer.player.stats.skills.religion.proficient,
                                                false
                                            )}
                                        </TableElement>
                                        <TableElement>
                                        ...
                                        <TableElement>
                                            {translate.t("Religion")} ({translate.t("Int")})
                    </TableElement>
                                    </tr>
                                    <tr>
                                        <TableElement>
                                        ...
                                        <TableElement>
                                            {translate.t("Sleight of hand")} ({translate.t("Dex")})
                    </TableElement>
                                    </tr>
                                    <tr>
                                        <TableElement>
                                            {parseStringBooleanToCheckmark(
                                                selectedPlayer.player.stats.skills.stealth.proficient,
                                                false
                                            )}
                                        </TableElement>
                                        <TableElement>
                                        ...
                                        <TableElement>
                                            {translate.t("Stealth")} ({translate.t("Dex")})
                    </TableElement>
                                    </tr>
                                    <tr>
                                        <TableElement>
                                            {parseStringBooleanToCheckmark(
                                                selectedPlayer.player.stats.skills.survival.proficient,
                                                false
                                            )}
                                        </TableElement>
                                        <TableElement>
                                        ...
                                        <TableElement>
                                            {translate.t("Survival")} ({translate.t("Wis")})
                    </TableElement>
                                    </tr>
                                </tbody>
                            </Table>
                ...
                {selectedPlayer.player.actions ? (
                    <NestedContainer style={{ width: "100%" }}>
                        <h3>{translate.t("Actions and specials")}:</h3>
                        {selectedPlayer.player.actions.map(
