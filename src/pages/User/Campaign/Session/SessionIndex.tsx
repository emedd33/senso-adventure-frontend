...
const SessionIndex: FunctionComponent<SessionIndexProps> = () => {
  ...
  return (
    <Switch>
      ...
      <Route
        exact
        path="/user/:username/campaigns/:campaignslug/sessions/:sessionslug"
      >
        <Session />
      </Route>
      ...
      <Route
        exact
        path="/user/:username/campaigns/:campaignslug/sessions/:sessionslug/edit"
      >
        <SessionEdit />
      </Route>
    </Switch>
