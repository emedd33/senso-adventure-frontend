        ...
        <Container>
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", margin: "1rem", marginLeft: 0 }}>
                <div>
                    ...
                    <h1 style={{ marginBottom: 0 }}>{`${selectedMonster.monster.name} ${selectedMonster.monster.isPublished === "FALSE" ? `(${translate.t(`Not published`)})` : ""}`}</h1>
                    {selectedMonster.monster.nickNames ? <h3 style={{ opacity: 0.7 }}>{translate.t(`Also known as`)}: {renderArrayOfString(selectedMonster.monster.nickNames)}</h3> : null}
                    <P>
            ...
            {isDungeonMaster ? <>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(10rem,20rem)" }}>
                    <div>
                        ...
                        <P><b>{translate.t(`Armor class`)}: </b>{selectedMonster.monster.stats.armorClass}</P>
                        <P><b>hp: </b>{selectedMonster.monster.stats.hitPoints} {selectedMonster.monster.stats.hitDice ? `(${selectedMonster.monster.stats.hitDice})` : null}</P>
                        <P><b>{translate.t(`Speed`)}: </b> {selectedMonster.monster.stats.speed ?
                    ...
                    <div>
                        <P><b>{translate.t(`Challenge rating`)}: </b>{selectedMonster.monster.challengeRating ? selectedMonster.monster.challengeRating : null}</P>
                        <P><b>{translate.t(`Languages`)}: </b>{selectedMonster.monster.languages ? renderArrayOfString(selectedMonster.monster.languages) : null}</P>
                        <P><b>{translate.t(`Senses`)}: </b> {selectedMonster.monster.senses ?
                            <ul style={{ marginTop: 0 }}>
                                {selectedMonster.monster.senses?.passive_perception ? <li><b>{translate.t(`Passive perception`)}: </b> {selectedMonster.monster.senses?.passive_perception} </li> : null}
                                {selectedMonster.monster.senses?.blindsight ? <li><b>{translate.t(`Blindsight`)}: </b> {selectedMonster.monster.senses?.blindsight} </li> : null}
                                {selectedMonster.monster.senses?.darkvision ? <li><b>{translate.t(`Darkvision`)}: </b> {selectedMonster.monster.senses?.darkvision} </li> : null}
                                {selectedMonster.monster.senses?.truesight ? <li><b>{translate.t(`Truesight`)}: </b> {selectedMonster.monster.senses?.truesight} </li> : null}
                ...
                <div style={{ display: "flex", flexWrap: "wrap", alignItems: "center", flexDirection: "row", justifyContent: "space-between", gap: "0.5rem", padding: "1rem", }}>
                    ...
                    <div style={{ display: "grid", gridTemplateColumns: "1fr 1 fr" }}>
                        <h2 style={{ gridColumn: "1/3", margin: 0 }}>{translate.t(`Str`)}</h2>
                    ...
                    {/* DEXTERITY */}
                    <div style={{ display: "grid", gridTemplateColumns: "1fr 1 fr" }}>
                        <h2 style={{ gridColumn: "1/3", margin: 0 }}>{translate.t(`Dex`)}</h2>
                    ...
                    {/* CONSTITUTION */}
                    <div style={{ display: "grid", gridTemplateColumns: "1fr 1 fr" }}>
                        <h2 style={{ gridColumn: "1/3", margin: 0 }}>{translate.t(`Con`)}</h2>
                    ...
                    {/* INTELLIGENCE */}
                    <div style={{ display: "grid", gridTemplateColumns: "1fr 1 fr" }}>
                        <h2 style={{ gridColumn: "1/3", margin: 0 }}>{translate.t(`Int`)}</h2>
                    ...
                    {/* WISDOM */}
                    <div style={{ display: "grid", gridTemplateColumns: "1fr 1 fr" }}>
                        <h2 style={{ gridColumn: "1/3", margin: 0 }}>{translate.t(`Wis`)}</h2>
                    ...
                    {/* CHARISMA */}
                    <div style={{ display: "grid", gridTemplateColumns: "1fr 1 fr" }}>
                        <h2 style={{ gridColumn: "1/3", margin: 0 }}>{translate.t(`Cha`)}</h2>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(10rem,20rem)" }}>
                    <div>
                        ...
                        {selectedMonster.monster.stats.proficiencies ? <P><b>{translate.t(`Proficiencies`)}: </b>
                            <ul style={{ marginTop: 0 }}>
                    ...
                    <div>
                        ...
                        {selectedMonster.monster.conditionImmunities ? <P><b>{translate.t(`Condition immunities`)}: </b>{renderArrayOfString(selectedMonster.monster.conditionImmunities)}
                        </P> : null}
                        {selectedMonster.monster.damageImmunities ? <P><b>{translate.t(`Damage immunities`)}: </b>{renderArrayOfString(selectedMonster.monster.damageImmunities)}
                        </P> : null}
                        {selectedMonster.monster.damageResistances ? <P><b>{translate.t(`Damage resistances`)}: </b>{renderArrayOfString(selectedMonster.monster.damageResistances)}
                        </P> : null}
                        {selectedMonster.monster.damageVulnerabilities ? <><DividerBlock /> <P><b>{translate.t(`Damage vulnerabilities`)}: </b>{renderArrayOfString(selectedMonster.monster.damageVulnerabilities)}
                        </P> </> : null}
                    </div>
                </div>
                ...
                {selectedMonster.monster.legendaryActions ? <>
                    ...
                    <SensoDraftJS readOnly={true} storagePath={`${monsterPath}/monsterLore.json`} isDungeonMaster={isDungeonMaster} />
                </>
                    : null}
