...
const MonsterIndex: FunctionComponent<MonsterIndexProps> = () => {
  ...
  return (
    <Switch>
      <Route
        exact
        path="/user/:username/campaigns/:campaignslug/monsters/:monsterslug"
      >
        <Monster />
      </Route>
      ...
      <Route
        exact
        path="/user/:username/campaigns/:campaignslug/monsters/:monsterslug/edit"
      >
        <MonsterEdit />
      </Route>
      <Route>
