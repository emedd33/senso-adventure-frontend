...
const LocationIndex: FunctionComponent<LocationIndexProps> = () => {
  ...
  return (
    <Switch>
      <Route
        exact
        path="/user/:username/campaigns/:campaignslug/locations/:locationslug"
      >
        <Location />
      </Route>
      ...
      <Route
        exact
        path="/user/:username/campaigns/:campaignslug/locations/:locationslug/edit"
      >
        <LocationEdit />
      </Route>
      <Route>
