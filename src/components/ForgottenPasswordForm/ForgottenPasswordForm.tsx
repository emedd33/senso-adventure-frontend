...
const ForgottenPasswordForm: React.FC<SignUpProps> = () => {
    ...
    const handleSubmit = () => {
        ...
        firebaseAuth.sendPasswordResetEmail(email).then(function () {
            dispatch(setAlertDialog("Email to reset password has been sent to ".concat(email), false, true))
        }).catch(function (error) {
            dispatch(setAlertDialog("Email adress '".concat(email).concat("' is invalid"), true, true))
        });
