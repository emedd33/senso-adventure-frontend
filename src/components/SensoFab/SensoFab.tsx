    ...
    >
      <Action
        ...
        onClick={() => {
          ...
          if (selectedCampaign) {
            history.push(
              `/user/${owner}/campaigns/${selectedCampaign.campaign.slug}/new-session`
            );
          }
        }}
      >
      ...
      >
        <img
          src={monsterIcon}
          style={{ width: "inherit" }}
          alt={translate.t("New monster/NPC")}
        />
      </Action>
      <Action
