...
const PlayerShort: React.FC<PlayerShortProps> = ({ player, isDungeonMaster }) => {
    const translate = useTranslation()
    if (isDungeonMaster) {
        return <div style={{ display: "grid", width: "100%", gap: "1rem", gridTemplateColumns: "repeat(auto-fit, minmax(10rem,30rem)" }}>
            <div >
            ...
            <div style={{ height: "10rem" }}>
                ...
                <LineContainer>
                    <b style={{ paddingRight: "0.2rem" }}>{translate.t('Armor class')}:  </b>{" "}
                    {player.stats.armorClass}
                </LineContainer>
                <LineContainer>
                    <b style={{ paddingRight: "0.2rem" }}>{translate.t('Proficiency')}:  </b>
                ...
                <Divider />
                <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,8rem)" }}>
